...
import {MemoizedReactMarkdown} from "../MarkdownRenderer"
import { FadeIn } from "../animations/FadeIn"
import { ResizablePanel } from "../animations/ResizablePanel"
import { Icons } from "../icons"
import { Sources } from "../perplexity/Sources"
...
export function AnswerCard({ question }: { question: string }, answer: { message: string }, isCurrentAnswer: boolean, status: string) {
  return (
    <div className=" py-10">
      <div
        className={cn(
...
export function AnswerMessage({ submittedQ, isCurrentAnswer, content, error }: { submittedQ: string, isCurrentAnswer: boolean, content: string, error: boolean }) {
  return (
    <>
